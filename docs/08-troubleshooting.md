...
| No Telegram notification | token/chat_id missing or wrong | expected if unset — scan still completes, results in the CSV; if set, re-check both values ([05](05-integrations.md)) |
