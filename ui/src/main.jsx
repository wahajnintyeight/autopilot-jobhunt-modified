...
function CompaniesWorkspace({ companies, scan, onSaved }) {
  ...
  const pageCount = Math.max(1, Math.ceil(filteredCompanies.length / COMPANY_PAGE_SIZE));
  const visibleCompanies = filteredCompanies.slice((page - 1) * COMPANY_PAGE_SIZE, page * COMPANY_PAGE_SIZE);
